  ...
  useEffect(() => {
    const fetchUsers = async () => {
      ...
      try {
        ...
        let url = `/api/user/approved-doctor?startIndex=${startIndex}&limit=${limit}`;
        if (filter) {
    ...
    <div className="dashboard my-flex">
      <div className="dashboardContainer my-flex">
        ...
        <div className="bg-gradient-to-r from-blue-700 to-cyan-500 rounded-lg border border-gray-200 p-10 w-full">
            <div className="text-5xl font-bold  text-white mb-4">Approved by Doctor</div>
            <p className="font-light my-4 text-white">
            View and manage students approved by doctor</p>
