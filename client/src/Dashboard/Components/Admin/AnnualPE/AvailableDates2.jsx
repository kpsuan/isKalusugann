...
const RescheduleDateCard = ({ date, remainingSlots, isSelected, onClick }) => (
    <Card
  ...
  const AvailableDates2 = ({ remainingSlots, selectedDate, onDateSelect }) => (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {remainingSlots.map(({ date, remainingSlots }, idx) => (
          <RescheduleDateCard
            ...
            onClick={() => onDateSelect(date)} // Notify parent of selection
          />
        ))}
      </div>
  ...
  export default AvailableDates2;
