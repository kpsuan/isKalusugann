  ...
  useEffect(() => {
    const fetchUsers = async () => {
      ...
      try {
        ...
        let url = `/api/user/inc-docs?startIndex=${startIndex}&limit=${limit}`;
        if (filter) {
  ...
  return (
    <div className="dashboard my-flex">
      <div className="dashboardContainer my-flex">
        ...
        <div className="bg-gradient-to-r from-red-700 to-rose-500 rounded-lg border border-gray-200 p-10 w-full">
            <div className="text-5xl font-bold  text-white mb-4">Incomplete Documents</div>
            <p className="font-light my-4 text-white">
            View and manage students with incomplete submission</p>
           
        </div>
        <div>
        <div className='p-4 pl-0 pt-4 mx-auto'>
