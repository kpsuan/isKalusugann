  ...
  return (
    <div className="dashboard my-flex">
      <div className="dashboardContainer my-flex">
        ...
        <div className="pb-14 bg-gradient-to-r from-green-700 to-cyan-500 rounded-lg border border-gray-200 p-10 w-full">
            <div className="text-5xl font-bold  text-white mb-4">No Documents Submitted</div>
            <p className="font-light my-4 text-white">
            View and manage students with no submission at all</p>
