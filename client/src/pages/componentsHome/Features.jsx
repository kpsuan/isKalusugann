        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            <div>
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Schedule & Reschedule Annual PE</h3>
            ...
            <div>
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Annual PE Attendance Monitoring</h3>
              <p className="text-gray-500 dark:text-gray-400">
              ...
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                ...
                >
                  <path
                    ...
                    clipRule="evenodd"
                  ></path>
                  <path d="M2 13.692V16a2 2 0 002 2h12a2 2 0 002-2v-2.308a24.974 24.974 0 01-16 0z"></path>
                </svg>
              </div>
              <h3 className="mb-2 text-xl font-bold dark:text-white">Download and Request Documents</h3>
              <p className="text-gray-500 dark:text-gray-400">
                Explore our list of audit-safe workflow templates for tracking works with peace of mind.
              </p>
            </div>
          </div>
        </div>
